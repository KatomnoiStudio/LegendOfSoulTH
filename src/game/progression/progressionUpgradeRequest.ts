 ...
 * กติกาจริง (ฮีโร่มีจริงไหม, ถึง max หรือยัง, ทองพอไหม, prerequisite ครบไหม, ปลดไปแล้วหรือยัง)
 * ถูกบังคับที่ฝั่งเซิร์ฟเวอร์ทั้งหมดตั้งแต่ migration 20260810180000 — ฝั่งนี้เหลือหน้าที่เดียวคือ
 * บอกว่า "จะอัปอะไร จากระดับไหน" ให้ตรงกับที่เซิร์ฟเวอร์จะอ่านเจอ ส่วนราคา **ไม่ส่งไปเลย**
 * เซิร์ฟเวอร์อ่านจาก `progression_cost_catalog` ของตัวเอง (`goldCost` ที่คืนกลับมาที่นี่มีไว้
 * โชว์บนจอเท่านั้น ไม่ได้เดินทางไปกับคำขอ)
 *
