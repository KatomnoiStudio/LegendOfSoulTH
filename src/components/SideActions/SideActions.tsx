  ...
  const actions: SideAction[] = [
    {
      id: 'settings',
      label: 'ตั้งค่า',
      icon: <img src={publicUrl('ui/thai/settings.webp')} alt="" draggable={false} />,
      onClick: onOpenSettings,
    },
    {
      id: 'mail',
      label: 'จดหมาย',
      icon: <img src={publicUrl('ui/thai/mail.webp')} alt="" draggable={false} />,
      count: badges.mail,
      onClick: () => comingSoon('จดหมาย'),
    },
    {
      id: 'mission',
      label: 'ภารกิจ',
      icon: <img src={publicUrl('ui/thai/mission.webp')} alt="" draggable={false} />,
      count: badges.mission,
      onClick: () => comingSoon('ภารกิจ'),
    },
    {
      id: 'add-friend',
      label: 'เพิ่มเพื่อน',
      icon: <img src={publicUrl('ui/thai/add-friend.webp')} alt="" draggable={false} />,
