...
export const ERROR_CODES = {
  ...
  // โหลดข้อมูลผู้เล่นจากเซิร์ฟเวอร์ไม่ครบ — VISIBLE เพราะเดินต่อด้วยข้อมูลครึ่ง ๆ กลาง ๆ แปลว่า
  // การเซฟครั้งถัดไปจะเขียนทับของจริงด้วยของว่าง (loadPlayer ยิง 8 ตารางพร้อมกัน เดิมเช็ค error
  // แค่ตารางเดียว ตารางที่เหลือล้มแล้วกลายเป็นอาร์เรย์ว่างเงียบ ๆ)
  PLAYER_LOAD_FAIL: 'โหลดข้อมูลผู้เล่นไม่สำเร็จ',

  // กู้ session ตอนเปิดเกมไม่สำเร็จ — VISIBLE เพราะถ้าเงียบ หน้าจอจะค้างที่สถานะ 'loading'
  // ตลอดไป (สถานะที่ไม่มี UI ไหนรับ) ปุ่มเริ่มเกมกดแล้วไม่มีอะไรเกิดขึ้นและไม่มีทางลองใหม่
  AUTH_SESSION_RESTORE_FAIL: 'กู้การเข้าสู่ระบบครั้งก่อนไม่สำเร็จ',
  ...
  // แถวรางวัลค้างตอนจบการต่อสู้เขียนไม่ลง — SILENT เพราะผู้เล่นยังไม่เสียอะไรและยังกดต่อได้
  // ตอนกดต่อ pipeline จะลองเขียนใหม่ แล้วค่อยแจ้งแบบเห็นได้ถ้ายังไม่ผ่าน
  REWARD_PENDING_RECORD_FAIL: 'บันทึกรางวัลค้างตอนจบการต่อสู้ไม่สำเร็จ',
