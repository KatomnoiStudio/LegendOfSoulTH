...
export const ERROR_CODES = {
  ...
  // สมัคร/เข้าสู่ระบบ/นำเข้าไฟล์ล้มด้วยข้อผิดพลาดที่ไม่คาดคิด — SILENT เพราะกล่องล็อกอิน
  // แสดงข้อความให้อยู่แล้ว มีรหัสไว้แยกว่าพังตรงไหน (WebCrypto ใช้ไม่ได้ / อ่านไฟล์พลาด /
  // แฮชในไฟล์เพี้ยน) ซึ่งข้อความบนจอตัวเดียวแยกไม่ออก
  AUTH_SUBMIT_FAIL: 'สมัครหรือเข้าสู่ระบบไม่สำเร็จด้วยข้อผิดพลาดที่ไม่คาดคิด',
  AUTH_IMPORT_FAIL: 'นำเข้าไฟล์ save ไม่สำเร็จด้วยข้อผิดพลาดที่ไม่คาดคิด',
