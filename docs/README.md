...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- |
| [`OPEN-FINDINGS-2026-08-12.md`](OPEN-FINDINGS-2026-08-12.md)       | Three HIGH defects found and **not fixed** — malformed public UIDs on every Google/guest account, an unrecoverable stalled battle-texture load, three tools that overwrite their own source. States its own coverage limits before its findings. | someone to fix them  |
...
| [`AUDIT-2026-08-12-v0.19.0.md`](AUDIT-2026-08-12-v0.19.0.md)                       | An eight-instrument audit at v0.19.0. §0 states its ceiling before the first finding.                                                                                     |
