...
- Origin, coverage, and known unknowns: [`assets/ATTRIBUTION.md`](assets/ATTRIBUTION.md) — **draft, pending owner sign-off.** Essentially all of the art was authored by `kaoshock123`; the document covers the Erlang Shen set (169 files) and the audio in detail, while the other 693 tracked assets have a known author but undocumented generation details.
