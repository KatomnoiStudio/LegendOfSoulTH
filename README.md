...
- The character, UI, and background art was **generated by AI**, then cut into animation frames and cleaned up in-repo by the scripts under `tools/` — not drawn by hand. Some generations used reference or source images, and their origins were not recorded, so the project **cannot currently claim the art is free of third-party input.**
