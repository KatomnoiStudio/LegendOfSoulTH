...
- The character, UI, and background art was **generated by AI agents**, then cut into animation frames and cleaned up in-repo by the scripts under `tools/` — not drawn by hand. Nothing was copied from another rightsholder's artwork.
...
- Per-directory origin, asserted licence, and the open questions AI generation raises: [`assets/ATTRIBUTION.md`](assets/ATTRIBUTION.md) — **draft, pending owner sign-off.**
