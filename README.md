...
- Origin, coverage, and known unknowns: [`assets/ATTRIBUTION.md`](assets/ATTRIBUTION.md) — **draft, pending owner sign-off.** It documents the Erlang Shen set (169 files) and the audio; the other 693 tracked assets predate the record and have no confirmed origin.
